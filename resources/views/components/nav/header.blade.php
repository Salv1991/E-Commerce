<header class="shadow-lg w-full" data-controller="responsive-nav-menu">
    <div class="p-5 max-w-screen-xl m-auto flex justify-between items-center gap-5">
        ...
        <div class="w-full hidden md:flex justify-between items-center gap-20">
            ...
            <div class="flex justify-center items-center gap-5">
                ...
                <div class="relative group">
                    ...
                    <div class="absolute top-7 -right-3 bg-white border border-gray-200 p-4 group-hover:block hidden">
                        <ul class="space-y-2">
                            <li>
