<div class="block md:hidden">
    <div data-responsive-nav-menu-target="responsiveMenuContainer" class="fixed z-50 top-0 right-0 left-0 bottom-0 bg-black/60 opacity-0 transition-opacity duration-500 pointer-events-none">
                    ...
                    <nav class="w-full flex flex-col justify-center items-center gap-5">
                        <ul class="w-full *:block *:w-full">
                            ...
                            @foreach ($categories as $category)    
                                <li class="group/firstDepthCategory">
                                    <div class="mobile-category flex flex-col justify-between items-center">
                                        
                                        {{-- FIRST DEPTH CATEGORIES --}}
                                        <x-nav.mobile.category :category="$category"  actionName="toggleMobileSubmenu" groupName="firstDepthCategory"/>
                                        ...
                                        <x-nav.mobile.category-card-container class="mobile-category-submenu">
                                            ...
                                            <ul class="w-full">
                                                @foreach ($category->children as $secondDepthCategory)
                                                    <li class="group/secondDepthCategory">
                                                        <div class="children-mobile-submenu flex flex-col justify-between items-center">
                                                            {{-- SECOND DEPTH CATEGORY --}}
                                                            <x-nav.mobile.category :category="$secondDepthCategory" actionName="toggleMobileChildrenSubmenu" groupName="secondDepthCategory"/>
