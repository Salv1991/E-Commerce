...
{{-- MESSAGES --}}
    ...
    <div class="bg-white min-h-[100vh] relative">
        ...
        <div class="max-w-screen-xl m-auto px-5 pt-10 relative" data-controller="order">
            <a href="/" class="block w-fit m-auto" >
                <img src="{{ asset('svg/logo7.png') }}" alt="Logo" class="h-36">
            </a>

            <h1 class="text-center text-3xl sm:text-5xl font-semibold mt-10">Order Information</h1>
